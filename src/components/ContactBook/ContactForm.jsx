    ...
    <div className="contacts__container">
      <form className="contacts__form" onSubmit={submitHandler}>
        ...
        <input
          ...
          className="input-field"
        />
        <label className="form-label" htmlFor="phone-id">
          Phone:
        </label>
        <input
          type="text"
        ...
        <label className="form-label" htmlFor="adress-id">
          Adress:
        </label>
        <input
          type="text"
          ...
          className="input-field"
        />
        <label className="form-label" htmlFor="company-id">
          Company:
        </label>
        <input
          type="text"
